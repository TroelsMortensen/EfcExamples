...
public class GoodreadsContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        try
        {
            optionsBuilder.UseSqlite(@"Data Source = C:\TRMO\RiderProjects\EfcExamples\Goodreads.Data\Goodreads.db");
            optionsBuilder.EnableSensitiveDataLogging();
        }
        catch (Exception e)
        {
            Console.WriteLine(
                "You may need to go to EfcExamples.Goodreads.Goodreads.data.GoodreadsContext and update the path to the datasource");
            Console.WriteLine(e);
            Console.WriteLine(
                "You may need to go to EfcExamples.Goodreads.Goodreads.data.GoodreadsContext and update the path to the datasource");
        }
