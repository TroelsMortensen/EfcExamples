...
public static class JsonSaver
{
    public static void SaveData(DataBaseModelContainer container)
    {
        ...
        File.WriteAllText(@"C:\TRMO\RiderProjects\EfcExamples\GoodreadsDataGeneration\DataCreation\Source\DataAsJson.json", serialized);
    }

    public static DataBaseModelContainer LoadData()
    {
        string asJson = File.ReadAllText(@"C:\TRMO\RiderProjects\EfcExamples\GoodreadsDataGeneration\DataCreation\Source\DataAsJson.json");
